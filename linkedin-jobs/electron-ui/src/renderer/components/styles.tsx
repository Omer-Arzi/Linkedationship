...
export const statusBadgeStyle = (bg: string, color: string, border: string) => ({
...
export const navButtonStyle = (active: boolean, hovered: boolean) => ({
...
export const navButtonIconStyle  = { fontSize: '16px' }
export const navButtonLabelStyle = { fontSize: '11px', fontWeight: 700, letterSpacing: '.3px' }
...
export const appHeaderTrafficLightsStyle = { display: 'flex', gap: '7px', WebkitAppRegion: 'no-drag' }

export const appHeaderDotRedStyle    = { width: 12, height: 12, borderRadius: '50%', background: '#ff5f57', display: 'inline-block' }
export const appHeaderDotYellowStyle = { width: 12, height: 12, borderRadius: '50%', background: '#febc2e', display: 'inline-block' }
export const appHeaderDotGreenStyle  = { width: 12, height: 12, borderRadius: '50%', background: '#28c840', display: 'inline-block' }

export const appHeaderTitleStyle   = { fontSize: '12px', fontWeight: 700, color: Colors.navText, letterSpacing: '.4px' }
export const appHeaderNoDragStyle = { WebkitAppRegion: 'no-drag' }

export const appBodyStyle = { display: 'flex', flex: 1, overflow: 'hidden' }
...
export const appTabPanelsStyle = { flex: 1, overflow: 'hidden', display: 'flex', position: 'relative' }

export const appTabPanelStyle = (visible: boolean) => ({
  display: visible ? 'flex' : 'none', flex: 1, overflow: 'hidden',
})

// ─── ScriptTab ────────────────────────────────────────────────────────────────

export const scriptTabRootStyle = {
  display: 'flex', flex: 1, overflow: 'hidden', background: Colors.bg,
}

export const scriptTabBrowserPanelStyle = {
  flex: '0 0 62%', display: 'flex', flexDirection: 'column',
  borderRight: `1px solid ${Colors.border}`, overflow: 'hidden',
}

export const scriptTabBrowserHeaderStyle = {
...
export const scriptTabBrowserBodyStyle = {
  flex: 1, overflow: 'hidden', position: 'relative', background: Colors.bgSurface,
}

export const scriptTabScreencastStyle = (dimmed: boolean) => ({
...
export const scriptTabSpinnerStyle = {
  width: 28, height: 28,
...
export const scriptTabSpinnerTextStyle = { fontSize: '13px', color: Colors.muted }

export const scriptTabLogPanelStyle = {
  flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden',
}

export const scriptTabLogHeaderStyle = {
  fontSize: '10px', fontWeight: 700, letterSpacing: '1.2px', textTransform: 'uppercase',
  color: Colors.muted, padding: '7px 14px 6px',
  background: Colors.bgSurface, borderBottom: `1px solid ${Colors.border}`, flexShrink: 0,
}

export const scriptTabLoginBannerStyle = {
  display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0,
  padding: '8px 14px', background: '#112840', borderBottom: '1px solid #1E4A70',
  color: '#A8C4DC', fontSize: '12px',
}

export const scriptTabContinueButtonStyle = {
...
export const scriptTabLogScrollStyle = {
...
export const scriptTabLogEntryStyle = (type: LogType, color: string) => ({
  padding: '1px 16px',
...
export const sentCheckboxCheckmarkStyle = {
...
export const cvFilterRootStyle = (open: boolean) => ({
...
export const cvFilterArrowStyle = (open: boolean) => ({
  width: '10px', height: '6px', color: Colors.muted, flexShrink: 0,
  transform: open ? 'rotate(180deg)' : 'none', transition: 'transform .15s',
})

export const cvFilterDropdownStyle = {
...
export const cvFilterOptionStyle = (selected: boolean) => ({
...
// ─── ResultsTab — DateGroup ───────────────────────────────────────────────────

export const dateGroupRootStyle = (effectiveCollapsed: boolean) => ({
  marginBottom: effectiveCollapsed ? '8px' : '32px',
})

export const dateGroupHeaderStyle = (effectiveCollapsed: boolean) => ({
  display: 'flex', alignItems: 'center', justifyContent: 'space-between',
...
export const dateGroupTbodyRowStyle = (sent: boolean) => ({
  '& td': {
...
export const dateGroupLinkButtonStyle = {
...
export const dateGroupTagStyle = {
...
export const resultsTabRootStyle = {
  display: 'flex', flexDirection: 'column', flex: 1, background: Colors.bg, overflow: 'hidden',
}

export const resultsTabHeaderStyle = {
  display: 'flex', alignItems: 'center', justifyContent: 'space-between',
  padding: '11px 20px', background: Colors.bgSurface,
  borderBottom: `1px solid ${Colors.border}`, flexShrink: 0,
}

export const resultsTabHeaderTitleStyle   = { fontSize: '14px', fontWeight: 700, color: Colors.text }
export const resultsTabHeaderActionsStyle = { display: 'flex', alignItems: 'center', gap: '8px' }

export const resultsTabSearchInputStyle = {
  height: '30px', padding: '0 12px',
...
export const resultsTabRefreshButtonStyle = {
...
export const resultsTabBodyStyle = {
...
export const resultsTabEmptyStyle = {
  color: Colors.muted, fontSize: '13px', textAlign: 'center', paddingTop: '64px',
}

// ─── ScheduleTab — Toggle ─────────────────────────────────────────────────────

export const toggleLabelStyle = { position: 'relative', flexShrink: 0, cursor: 'pointer' }
export const toggleInputStyle = { position: 'absolute', opacity: 0, width: 0, height: 0 }

export const toggleTrackStyle = (checked: boolean) => ({
  display: 'block', width: '40px', height: '24px', borderRadius: '12px',
  background: checked ? Colors.blue : Colors.border,
  transition: 'background .2s', position: 'relative',
})

export const toggleThumbStyle = (checked: boolean) => ({
...
// ─── ScheduleTab — SettingRow ─────────────────────────────────────────────────

export const settingRowStyle = (disabled?: boolean) => ({
  display: 'flex', alignItems: 'center', justifyContent: 'space-between',
...
export const settingRowContentStyle = { display: 'flex', flexDirection: 'column', gap: '3px', flex: 1 }
export const settingRowLabelStyle   = { fontSize: '13px', fontWeight: 600, color: Colors.text }
export const settingRowDescStyle    = { fontSize: '12px', color: Colors.muted, lineHeight: 1.4 }

// ─── ScheduleTab — shell ──────────────────────────────────────────────────────

export const scheduleTabRootStyle = {
  display: 'flex', flexDirection: 'column', flex: 1, background: Colors.bg, overflow: 'hidden',
}

export const scheduleTabHeaderStyle = {
  display: 'flex', alignItems: 'center',
  padding: '11px 20px', background: Colors.bgSurface,
  borderBottom: `1px solid ${Colors.border}`, flexShrink: 0,
}

export const scheduleTabHeaderTitleStyle = { fontSize: '14px', fontWeight: 700, color: Colors.text }

export const scheduleTabBodyStyle = {
  flex: 1, overflowY: 'auto', padding: '24px',
  display: 'flex', flexDirection: 'column', gap: '20px', maxWidth: '640px',
}

export const scheduleTabSectionStyle = {
  background: Colors.bgSurface, border: `1px solid ${Colors.border}`,
  borderRadius: '10px', overflow: 'hidden',
}

export const scheduleTabDaysContainerStyle = { display: 'flex', gap: '6px', flexWrap: 'wrap' }
export const scheduleTabDayLabelStyle      = { cursor: 'pointer' }
export const scheduleTabDayCheckboxStyle   = { display: 'none' }

export const scheduleTabDayBoxStyle = (sel: boolean, enabled: boolean) => ({
...
export const scheduleTabTimeInputsStyle = { display: 'flex', alignItems: 'center', gap: '2px' }
export const scheduleTabColonStyle       = { fontSize: '14px', fontWeight: 600, color: Colors.muted }

export const scheduleTabTimeInputStyle = (hasError: boolean) => ({
...
export const scheduleTabApiKeyBodyStyle = {
  display: 'flex', alignItems: 'center', gap: '8px', padding: '0 20px 16px',
}

export const scheduleTabApiKeyInputStyle = {
...
export const scheduleTabShowKeyButtonStyle = {
  background: 'none', border: 'none', cursor: 'pointer',
  fontSize: '16px', padding: '4px', opacity: 0.6, transition: 'opacity .15s',
  '&:hover': { opacity: 1 },
}

export const scheduleTabFooterStyle = {
  display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '4px 0',
}

export const scheduleTabStatusTextStyle = (color: string) => ({
  fontSize: '12px', fontWeight: 600, color,
})

export const scheduleTabSaveButtonStyle = (saving: boolean) => ({
